...
const Contact = () => {
  return (
    <div
      name="contact"
      className="contact bg-gradient-to-b from-black to-gray-800 p-4 text-white w-full md:h-screen"
    >
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        ...
        <div className=" flex justify-center items-center">
          <form
            ...
            name="contact"
            method="POST"
            action="https://getform.io/f/a1012f06-fc60-47e9-b023-dafd47c0c3d1"
